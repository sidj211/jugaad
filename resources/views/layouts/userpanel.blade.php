            ...
            <div id="tg-verticalscrollbar" class="tg-verticalscrollbar">
                ...
                <div class="tg-socialandappicons">
                    ...
                    <ul class="tg-appstoreicons">
                        <li><a href="javascript:void(0)"><img src="/assets/images/icons/app-01.png" alt="image description"></a></li>
                        <li><a href="javascript:void(0)"><img src="/assets/images/icons/app-02.png" alt="image description"></a></li>
                    </ul>
                </div>
            </div>
        </div>
